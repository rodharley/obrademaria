...
$mensagem = 'Grupo: '.$_REQUEST['grupo'].'<br/>'.'Nome: '.$_REQUEST['nome'].'<br/>'.'Email: '.$_REQUEST['email'].'<br/>'.'Mensagem: '.$_REQUEST['message'];
}else{
$mensagem = 'Email: '.$_REQUEST['email'].'<br/>'.'Mensagem: '.$_REQUEST['message'];    
}

if($tupi->mail_html($tupi->DESTINATARIO,$tupi->REMETENTE, 'Email do Site', $mensagem)){
